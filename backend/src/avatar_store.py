...
_WORDS = [
    "able", "acid", "aged", "also", "area", "army", "arts", "aunt",
    "auto", "away", "baby", "back", "ball", "band", "bank", "base",
    "bath", "beam", "bean", "bear", "bell", "belt", "best", "bike",
    "bird", "blue", "boat", "body", "bolt", "bone", "book", "boot",
    "born", "bowl", "brew", "bulb", "burn", "bush", "busy", "cake",
    "calf", "calm", "camp", "card", "care", "case", "cash", "cast",
    "cave", "cell", "chef", "chip", "city", "clay", "clip", "club",
    "coal", "coat", "code", "coin", "cold", "comb", "cone", "cook",
    "cope", "copy", "cord", "core", "cork", "corn", "cost", "cove",
    "crab", "crew", "crop", "cube", "cure", "curl", "cute", "dare",
    "dash", "dawn", "deep", "deer", "desk", "diet", "dock", "doll",
    "door", "dove", "drag", "drew", "drop", "drum", "duck", "dusk",
    "dust", "duty", "earn", "east", "easy", "eddy", "edge", "envy",
    "even", "exam", "face", "fade", "fair", "farm", "fast", "feel",
    "fern", "ferr", "feud", "file", "film", "find", "fine", "fire",
    "fish", "flag", "flax", "flex", "flop", "flow", "foam", "fold",
    "fond", "food", "fork", "form", "fort", "four", "free", "frog",
    "fuel", "full", "fund", "fuse", "gain", "gait", "gale", "game",
    "gate", "gear", "gift", "give", "glad", "glee", "glow", "goal",
    "goat", "gold", "golf", "good", "gram", "grew", "grin", "grit",
    "grip", "grow", "gulf", "gull", "hail", "hair", "half", "hall",
    "hand", "harp", "hawk", "haze", "head", "heap", "help", "herb",
    "hero", "high", "hike", "hill", "hint", "hive", "hold", "hole",
    "home", "hoof", "hope", "hose", "host", "hour", "huge", "hunt",
    "icon", "idea", "iron", "isle", "item", "jade", "jazz", "jeep",
    "jest", "joke", "jolt", "joy", "judo", "jump", "june", "kart",
    "keen", "kelp", "kept", "kept", "kind", "king", "kite", "kiwi",
    "knee", "knit", "knob", "knot", "lace", "lake", "lamp", "lane",
    "lash", "lava", "lawn", "leaf", "lean", "lens", "lift", "lime",
    "line", "link", "lion", "list", "loaf", "loft", "long", "loom",
    "loop", "loud", "love", "luck", "lung", "made", "mail", "main",
    "make", "many", "mark", "mash", "mask", "math", "maze", "meal",
]
...
_BACKFILL_BASE = [
    "mind", "mint", "mist", "moat", "mold", "moon", "moss", "moth",
    "much", "mule", "must", "myth", "nail", "name", "navy", "near",
    "neat", "neck", "nest", "news", "next", "nice", "nine", "noon",
    "nose", "note", "oak", "oats", "ocean", "odor", "ohm", "oil",
    "okra", "once", "only", "open", "opus", "oral", "orca", "oven",
    "page", "pail", "pair", "palm", "pane", "park", "pass", "past",
    "path", "peak", "pear", "peat", "pelt", "perk", "phlox", "pick",
    "pier", "pike", "pill", "pine", "ping", "pink", "pint", "pipe",
    "plan", "play", "plug", "plum", "plus", "poem", "poet", "pole",
    "pond", "pool", "pope", "post", "pour", "pram", "pray", "prep",
    "prim", "prop", "puck", "puff", "pull", "pulp", "pump", "punt",
    "pure", "push", "quad", "quay", "quiz", "race", "rage", "rail",
    "rain", "rake", "ramp", "rank", "rare", "rash", "raze", "read",
    "real", "reap", "reed", "reef", "rein", "rely", "rent", "rice",
    "ride", "rift", "ring", "rink", "rise", "risk", "road", "robe",
    "rock", "rode", "roll", "roof", "rook", "room", "root", "rope",
    "rose", "ruby", "rude", "rule", "rune", "rust", "safe", "sail",
    "salt", "same", "sand", "sane", "sash", "sauce", "save", "scar",
    "scrap", "seal", "seam", "seed", "seek", "self", "send", "ship",
    "shop", "show", "shy", "side", "silk", "sing", "sink", "site",
    "size", "skim", "skin", "skip", "slab", "slap", "sled", "slim",
    "slip", "slot", "snap", "snow", "soap", "sock", "soda", "soft",
    "soil", "sole", "solo", "song", "soon", "sort", "soul", "soup",
    "spa", "spar", "spin", "spry", "spur", "stem", "stop", "sun",
    "swan", "tape", "team", "tide", "tile", "time", "tint", "toad",
    "tone", "tool", "torch", "tour", "town", "trap", "tree", "trim",
    "trip", "tuft", "tuna", "turf", "tusk", "twig", "type", "user",
    "vase", "veil", "vein", "vine", "vivid", "vow", "wave", "wax",
    "well", "whim", "whip", "wing", "wink", "wire", "wise", "wolf",
    "wood", "wool", "word", "wren", "yarn", "yard", "year", "yoga",
    "yolk", "yurt", "zebra", "zero", "zest", "zinc", "zone", "zoom",
]
...
class AvatarStore:
    ...
    def _insert(self, new_uuid: str, *, avatar_type: str,
                avatar_path: Optional[str] = None,
                gravatar_hash: Optional[str] = None) -> tuple[str, str]:
        code = generate_code()
        ...
        with self._lock:
            ...
            try:
                conn.execute(
                    ...
                    VALUES (?, ?, ?, ?, ?, NULL, ?, ?)
                    """,
                    (new_uuid, avatar_type, _hash_code(code), avatar_path,
                     gravatar_hash, now, now),
                )
            finally:
                conn.close()
        self._logger.info(
            f"Created {avatar_type} avatar {new_uuid[:8]}... "
            f"(bcrypt={_HAS_BCRYPT})"
        )
        return new_uuid, code

    def get(self, avatar_uuid: str) -> Optional[dict]:
    ...
    def recover_by_code(self, code: str) -> Optional[str]:
        ...
        with self._lock:
            ...
            try:
                rows = conn.execute(
                    "SELECT uuid, code_hash FROM avatars"
                ).fetchall()
            finally:
                conn.close()
        for row in rows:
    ...
    def find_by_emby_user(self, emby_user_id: str) -> Optional[str]:
