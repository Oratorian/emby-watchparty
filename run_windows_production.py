"""
Windows production entrypoint for Emby Watch Party
Uses gevent for production-ready async handling on Windows
"""
...
if __name__ == '__main__':
    logger.info("=" * 80)
    logger.info("Starting Emby Watch Party server (Windows Production Mode)...")
